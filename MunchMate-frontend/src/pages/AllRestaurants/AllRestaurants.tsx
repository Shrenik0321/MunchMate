...
const AllRestaurants = () => {
  ...
  const tableHeaders = ["Name", "Email", "Contact Number", "Address"];
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="grid grid-cols-8 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
            {tableHeaders.map((header) => (
              <div className="col-span-2 flex items-center" key={header}>
          ...
          {restaurants.map((restaurant: any, key: number) => (
            <div
              className="grid grid-cols-8 border-t border-stroke py-3 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5 hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer transition-colors duration-200"
              key={key}
